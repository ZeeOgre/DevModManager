...
{
    /// <summary>
    /// The standard ConfirmInstallDirDialog.
    ...
    public partial class ConfirmInstallDirDialog : WpfDialog, IWpfDialog
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfirmInstallDirDialog"/> class.
        /// </summary>

        public ConfirmInstallDirDialog()
        {
            InitializeComponent();
            this.Loaded += ConfirmInstallDirDialog_Loaded;
        }

        private void ConfirmInstallDirDialog_Loaded(object sender, RoutedEventArgs e)
        {
            // Initial check and modification of the InstallDirPath
            UpdateInstallDirPath();
        }

        private void UpdateInstallDirPath()
        {
            string installDir = InstallDirPath.Text;

            if (!installDir.EndsWith(@"\DevModManager", StringComparison.OrdinalIgnoreCase))
            {
                InstallDirPath.Text = System.IO.Path.Combine(installDir, "DevModManager");
            }
        }
        ...
        public void Init()
        {
            ViewModelBinder.Bind(new ConfirmInstallDirDialogModel { Host = ManagedFormHost, }, this, null);
        }
    }

    /// <summary>
    /// ViewModel for standard ConfirmInstallDirDialog.
    /// <para>Follows the design of the canonical Caliburn.Micro ViewModel (MVVM).</para>
    /// <para>See https://caliburnmicro.com/documentation/cheat-sheet</para>
    /// </summary>
    internal class ConfirmInstallDirDialogModel : Caliburn.Micro.Screen
    {
