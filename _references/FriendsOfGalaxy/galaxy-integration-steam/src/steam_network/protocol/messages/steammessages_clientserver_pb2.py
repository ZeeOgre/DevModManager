...
_CMSGGAMESERVERPOLICYUPDATE = DESCRIPTOR.message_types_by_name['CMsgGameServerPolicyUpdate']
...
CMsgGameServerPolicyUpdate = _reflection.GeneratedProtocolMessageType('CMsgGameServerPolicyUpdate', (_message.Message,), {
  'DESCRIPTOR' : _CMSGGAMESERVERPOLICYUPDATE,
  '__module__' : 'steammessages_clientserver_pb2'
  # @@protoc_insertion_point(class_scope:CMsgGameServerPolicyUpdate)
  })
_sym_db.RegisterMessage(CMsgGameServerPolicyUpdate)
