...
_CMSGCLIENTPICSPRIVATEBETAREQUEST = DESCRIPTOR.message_types_by_name['CMsgClientPICSPrivateBetaRequest']
_CMSGCLIENTPICSPRIVATEBETARESPONSE = DESCRIPTOR.message_types_by_name['CMsgClientPICSPrivateBetaResponse']
...
CMsgClientPICSPrivateBetaRequest = _reflection.GeneratedProtocolMessageType('CMsgClientPICSPrivateBetaRequest', (_message.Message,), {
  'DESCRIPTOR' : _CMSGCLIENTPICSPRIVATEBETAREQUEST,
  '__module__' : 'steammessages_clientserver_appinfo_pb2'
  # @@protoc_insertion_point(class_scope:CMsgClientPICSPrivateBetaRequest)
  })
_sym_db.RegisterMessage(CMsgClientPICSPrivateBetaRequest)

CMsgClientPICSPrivateBetaResponse = _reflection.GeneratedProtocolMessageType('CMsgClientPICSPrivateBetaResponse', (_message.Message,), {
  'DESCRIPTOR' : _CMSGCLIENTPICSPRIVATEBETARESPONSE,
  '__module__' : 'steammessages_clientserver_appinfo_pb2'
  # @@protoc_insertion_point(class_scope:CMsgClientPICSPrivateBetaResponse)
  })
_sym_db.RegisterMessage(CMsgClientPICSPrivateBetaResponse)
