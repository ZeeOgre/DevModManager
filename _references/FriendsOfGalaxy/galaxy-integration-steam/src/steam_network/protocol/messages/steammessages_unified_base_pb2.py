...
_EPROTOSERVICETYPE = DESCRIPTOR.enum_types_by_name['EProtoServiceType']
EProtoServiceType = enum_type_wrapper.EnumTypeWrapper(_EPROTOSERVICETYPE)
k_EProtoExecutionSiteUnknown = 0
k_EProtoExecutionSiteSteamClient = 2
k_EProtoServiceTypeSteamMessages = 0
k_EProtoServiceTypeVRGamepadUIMessages = 1

MESSAGE_DESCRIPTION_FIELD_NUMBER = 51000
message_description = DESCRIPTOR.extensions_by_name['message_description']
FORCE_EMIT_MESSAGE_FIELD_NUMBER = 50026
force_emit_message = DESCRIPTOR.extensions_by_name['force_emit_message']
...
SERVICE_TYPE_FIELD_NUMBER = 50025
service_type = DESCRIPTOR.extensions_by_name['service_type']
FORCE_EMIT_SERVICE_FIELD_NUMBER = 50026
force_emit_service = DESCRIPTOR.extensions_by_name['force_emit_service']
