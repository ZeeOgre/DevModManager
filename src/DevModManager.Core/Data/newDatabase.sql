--
-- File generated with SQLiteStudio v3.4.17 on Thu Dec 4 14:40:28 2025
--
...
CREATE TABLE FolderType (
    ...
    IsEnvironmentFolder INTEGER NOT NULL
                                ...
                                DEFAULT (0) 
                                CHECK ( (IsRelative = 1 AND
                                         ParentFolderTypeId IS NOT NULL) OR
                                        (IsRelative != 1) ) 
);
...
CREATE TABLE StageBranchMapping (
    id              INTEGER PRIMARY KEY AUTOINCREMENT
                            NOT NULL,
